...
# validazione credenziali con retry
...
def validate_credentials(client: AzureOpenAI, model_name: str) -> bool:
    try:
        ...
        st.error("Chiavi di configurazioni errate")
        return False
    
    except BadRequestError as e:
        st.error(f"Richiesta non valida")
        return False
    
    except Exception as e:
        st.error(f"Errore temporaneo")
        raise e
