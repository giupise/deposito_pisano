...
from tools.rag_w_qdrant.main import rag_system


@CrewBase
class CulinaryRagCrew():
    """
    Culinary RAG (Retrieval-Augmented Generation) Crew for culinary questions.
    
    This crew specializes in answering culinary-related questions using a RAG system
